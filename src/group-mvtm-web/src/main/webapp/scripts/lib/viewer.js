...
(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('viewer', ['jquery','./app/wosa','./app/util'], factory);
  ...
  Viewer.prototype = {
    ...
    initImage: function (callback) {
      ...
      getImageSize($image[0], $.proxy(function (naturalWidth, naturalHeight) {
        ...
        image = {
          ...
          left: ($image.parent().width() - width) / 2,
      ...
      //cobain
      var _needWidth = 1568;
      var _zoomRatio = _needWidth / (this.image.naturalWidth) - 1;
      this.zoom(_zoomRatio,false,null);
    },
    ...
    hidden: function () {
      ...
      $$.debug("viewer关闭前,调用c#的restoreZoom方法");
    ...
    '<div class="viewer-container">' +
      ...
      '<div class="viewer-footer">' +
        ...
        '<ul class="viewer-toolbar">' +
          ...
          '<li class="viewer-one-to-one" data-action="one-to-one" title="1:1"></li>' +
          '<li class="viewer-reset" data-action="reset" title="reset"></li>' +
          '<li class="viewer-prev" data-action="prev" title="prev"></li>' +
          '<li class="viewer-play" data-action="play" title="play"></li>' +
          '<li class="viewer-next" data-action="next" title="next"></li>' +
      ...
      '<div class="viewer-button" data-action="mix" title="Close"></div>' +
